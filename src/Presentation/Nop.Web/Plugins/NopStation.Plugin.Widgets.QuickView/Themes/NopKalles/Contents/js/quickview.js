var QuickView = {
  ...
  render_quickview_button: function (label) {
    $('.product-item[data-quick-view!="true"]').each(function (i, obj) {
      ...
      var html = '<button type="button" class="button-2 quick-view-btn d-none d-lg-inline-block position-relative text-center text-capitalize add-btn add-qv" data-productid="' + productid + '" title="' + label + '"><i class="btn-icon lnr lnr-eye"></i><span class="btn-txt">' + label + '</span></button>';
      $(this).append(html);
