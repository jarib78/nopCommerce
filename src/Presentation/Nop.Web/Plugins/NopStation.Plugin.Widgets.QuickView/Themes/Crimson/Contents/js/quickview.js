...
var QuickView = {
  ...
  render_quickview_button: function (label) {
    $('.product-item[data-quick-view!="true"]').each(function (i, obj) {
      ...
      var html = '<i><a title="Quick view" data-productid="' + productid + '" title="' + label + '" class="quick-view-btn text-white"><i class="fa fa-eye" aria-hidden="true"></i></a></i>';
      $(this).children('.details').children('.add-info').children('.products-box-icon').append(html);
