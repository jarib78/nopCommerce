...
var QuickView = {
  ...
  render_quickview_button: function (label) {
    $('.product-item[data-quick-view!="true"]').each(function (i, obj) {
      ...
      var html = '<button type="button" class="button-2 quick-view-button beautyShop-primary-color-bg" data-productid="' + productid + '" title="' + label + '"><i class="icon-zoom"></i></button>';
